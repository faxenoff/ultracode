...
- **llmModels** — Filters models to exclude those with embedding patterns `llm-provider.ts:301-304`, `llm-provider.ts:303-303`
...
### Method
- **checkHealth** — Checks the health of the LLM provider `llm-provider.ts:94-116`, `llm-provider.ts:204-215`, `llm-provider.ts:279-338`, `llm-provider.ts:454-477`, `llm-provider.ts:632-684`, `llm-provider.ts:935-952`
- **constructor** — Initializes the OllamaProvider instance `llm-provider.ts:81-84`
- **constructor** — Initializes the LLM provider with configuration `llm-provider.ts:196-198`, `llm-provider.ts:269-273`
- **constructor** — Initializes the LLM provider with the given configuration `llm-provider.ts:440-444`
- **constructor** — Initializes the LLMProvider with configuration options `llm-provider.ts:557-572`
- **constructor** — Initializes the ClaudeCodeProvider with necessary parameters `llm-provider.ts:876-884`
- **findLLMModelPath** — Finds the path to the LLM model `llm-provider.ts:585-630`
- **generate** — Generates text using the LLM provider `llm-provider.ts:152-185`, `llm-provider.ts:228-256`, `llm-provider.ts:697-734`, `llm-provider.ts:958-976`
- **generate** — Generates a response based on the provided prompt and options `llm-provider.ts:353-417`
- **generate** — Generates text based on a prompt `llm-provider.ts:502-539`
- **getUsageStats** — Retrieves usage statistics for the LLM provider `llm-provider.ts:889-907`
- **isAvailable** — Returns whether the LLM provider is available `llm-provider.ts:86-88`, `llm-provider.ts:200-202`, `llm-provider.ts:275-277`
- **isAvailable** — Indicates whether the LLM provider is available `llm-provider.ts:446-448`
- **isAvailable** — Checks if the LLM provider is available `llm-provider.ts:574-576`, `llm-provider.ts:927-929`
- **listModels** — Lists available models for the LLM provider `llm-provider.ts:141-150`, `llm-provider.ts:217-226`, `llm-provider.ts:686-695`, `llm-provider.ts:954-956`
- **listModels** — Returns a promise of a list of available models `llm-provider.ts:340-351`
- **listModels** — Lists available models `llm-provider.ts:491-500`
...
- **selectedModel** — Stores the currently selected model for the LLM provider `llm-provider.ts:578-580`, `llm-provider.ts:931-933`
...
### Property
- **_isAvailable** — Indicates whether the LLM provider is available `llm-provider.ts:77-77`, `llm-provider.ts:193-193`, `llm-provider.ts:264-264`, `llm-provider.ts:436-436`, `llm-provider.ts:863-863`
- **_isAvailable** — A private property indicating the availability of the LLM provider `llm-provider.ts:550-550`
- **_totalUsage** — Stores the total usage statistics for the LLM provider `llm-provider.ts:868-874`
- **apiKey** — The API key for the LLM provider, if applicable `llm-provider.ts:21-21`
- **apiKey** — Stores the API key for the LLM provider `llm-provider.ts:267-267`, `llm-provider.ts:269-269`
...
- **baseUrl** — The base URL for the LLM provider's API `llm-provider.ts:19-19`
- **baseUrl** — Stores the base URL for the LLM provider `llm-provider.ts:78-78`, `llm-provider.ts:81-81`, `llm-provider.ts:194-194`, `llm-provider.ts:196-196`, `llm-provider.ts:265-265`, `llm-provider.ts:269-269`
- **baseUrl** — Represents the base URL for the LLM provider `llm-provider.ts:437-437`, `llm-provider.ts:440-440`
- **baseUrl** — The base URL for the LLM provider `llm-provider.ts:551-551`
- **baseUrl** — Sets the base URL for the LLM provider `llm-provider.ts:558-558`
...
- **content** — Represents a message object with content `llm-provider.ts:394-394`, `llm-provider.ts:527-527`
- **content** — Represents a message object with role and content `llm-provider.ts:503-503`
- **content** — Stores content generated by the LLM provider `llm-provider.ts:698-698`, `llm-provider.ts:722-722`
- **data** — Represents the data structure for LLM configurations `llm-provider.ts:296-296`, `llm-provider.ts:346-346`
- **data** — Stores the parsed JSON response containing an array of IDs `llm-provider.ts:495-495`
- **data** — Stores data related to the LLM provider `llm-provider.ts:690-690`
...
- **id** — Extracts the model IDs from the response `llm-provider.ts:296-296`, `llm-provider.ts:346-346`
- **id** — Stores the parsed JSON response containing an array of IDs `llm-provider.ts:495-495`
- **id** — Stores an identifier for the LLM provider `llm-provider.ts:690-690`
...
- **isAvailable** — Indicates whether the TGI provider is available `llm-provider.ts:40-40`
- **language** — An optional parameter specifying the language for documentation generation `doc-writer.ts:102-102`, `doc-writer.ts:128-128`
- **language** — Language name mapping — synced with Zig's batch_generator.zig (16 languages) `doc-writer.ts:269-269`, `doc-writer.ts:462-462`
- **maxTokens** — The maximum number of tokens allowed for the LLM response `llm-provider.ts:22-22`, `llm-provider.ts:49-49`
- **message** — Represents a message object with content `llm-provider.ts:394-394`, `llm-provider.ts:527-527`
- **message** — Stores a message related to the LLM provider `llm-provider.ts:722-722`
- **model** — The specific model to use for the LLM provider `llm-provider.ts:20-20`
- **model** — Stores the selected model for the LLM provider `llm-provider.ts:79-79`, `llm-provider.ts:81-81`, `llm-provider.ts:864-864`, `llm-provider.ts:876-876`
- **model** — Stores the model name for the LLM provider `llm-provider.ts:266-266`, `llm-provider.ts:269-269`
- **model** — Represents the selected model for the LLM provider `llm-provider.ts:438-438`
- **model** — The name of the selected model `llm-provider.ts:440-440`, `llm-provider.ts:552-552`
- **model** — Sets the model to use for the LLM provider `llm-provider.ts:559-559`
- **model** — Specifies the LLM model `llm-provider.ts:1266-1266`
...
- **name** — The name of the LLM provider `llm-provider.ts:39-39`, `llm-provider.ts:549-549`
- **name** — Stores the name of the LLM provider `llm-provider.ts:76-76`, `llm-provider.ts:145-145`, `llm-provider.ts:862-862`
- **name** — Represents the name of the LLM provider `llm-provider.ts:192-192`, `llm-provider.ts:263-263`, `llm-provider.ts:435-435`
...
- **selectedModel** — Represents the currently selected model `llm-provider.ts:41-41`
