...
- **autodocResult** — Represents the result of auto-doc synchronization `service-container.ts:207-207`, `service-container.ts:208-208`
- **bgPromise** — Represents a background promise for asynchronous operations `auto-indexer.ts:480-586`
- **buildAutoIndexExcludePatterns** — Builds exclude patterns for source file counting and indexing `auto-indexer.ts:167-261`
- **buildTrigramIndex** — Builds a trigram index for text processing `auto-indexer.ts:620-687`
...
- **childHashes** — Stores the hashes of child nodes `file-merkle.ts:424-424`, `file-merkle.ts:588-588`
...
- **countSourceFiles** — Counts the number of source files in a project `auto-indexer.ts:141-159`
...
- **detectSupportedProject** — Detects a supported project based on file extensions `auto-indexer.ts:103-135`
...
- **extList** — A list of supported file extensions `auto-indexer.ts:112-112`, `auto-indexer.ts:144-144`
- **faissSavePromise** — Represents a promise for saving Faiss index data `auto-indexer.ts:486-498`
...
- **msValues** — Stores the time values in milliseconds for various operations `auto-indexer.ts:427-427`
...
- **noop** — Define a no-op function for Bun+quiet mode `environment-setup.ts:27-27`, `environment-setup.ts:35-35`
...
- **performAutoIndex** — Executes the automatic indexing process `auto-indexer.ts:310-610`
...
- **sizes** — Stores the sizes of the input data `auto-indexer.ts:428-428`
- **sizeStr** — Converts sizes to a string representation `auto-indexer.ts:429-429`
- **sortedDirs** — Sorts directories by their depth `file-merkle.ts:166-166`
- **srcResult** — Represents the result of source code modification `service-container.ts:222-222`, `service-container.ts:223-223`
...
- **watcher** — Represents the file watcher for a specific directory `file-watcher.ts:227-240`, `file-watcher.ts:266-279`
...
- **close** — Closes the pipe transport `pipe-transport.ts:233-237`, `pipe-transport.ts:327-341`
...
- **constructor** — Initializes a new instance of the SnapshotRing class `resource-manager.ts:65-67`, `resource-manager.ts:141-161`
...
- **start** — Starts the pipe transport `pipe-transport.ts:194-217`, `pipe-transport.ts:296-325`
...
- **AgentWithEmbeddingStats** — Interface for an agent that includes embedding statistics `auto-indexer.ts:33-45`
- **AgentWithRepositoryPath** — An interface for an agent that can set its repository path `auto-indexer.ts:50-52`
- **AutoIndexContext** — Manages the context for automatic indexing operations `auto-indexer.ts:296-304`
- **AutoIndexOptions** — Options for auto-indexing `auto-indexer.ts:266-271`
- **AutoIndexResult** — Represents the result of an auto-indexing task `auto-indexer.ts:276-290`
...
- **TaskProcessingResult** — Represents the result of task processing, including success status, entities extracted, files processed, and extracted data `auto-indexer.ts:19-28`
...
- **../logging/index.js** — Imports `../logging/index.js` from `../logging/index.js`. `agent-registry.ts:9-9`, `auto-indexer.ts:8-8`, `branch-manager.ts:15-15`, `client-session.ts:15-15`, `di-container.ts:17-17`, `file-merkle.ts:17-17`, `file-watcher.ts:21-21`, `git-watcher.ts:16-16`, `knowledge-bus.ts:7-7`, `merkle-file-tracker.ts:16-16`, `pipe-transport.ts:10-10`, `resource-manager.ts:13-13`, `shutdown-handlers.ts:10-10`, `startup-checks.ts:11-11`, `startup-utils.ts:10-10`
...
- **../shared/git-worktree.js** — Imports `../shared/git-worktree.js` from `../shared/git-worktree.js`. `auto-indexer.ts:9-9`, `client-session.ts:16-16`
...
- **../types/agent.js** — Imports `../types/agent.js` from `../types/agent.js`. `agent-registry.ts:10-10`, `agent-registry.ts:11-11`, `auto-indexer.ts:10-10`, `auto-indexer.ts:11-11`, `di-container.ts:18-18`, `knowledge-bus.ts:8-8`, `resource-manager.ts:14-14`, `shutdown-handlers.ts:17-17`
...
- **../utils/logger.js** — Imports `../utils/logger.js` from `../utils/logger.js`. `auto-indexer.ts:12-12`
...
- **./indexing-state.js** — Imports `./indexing-state.js` from `./indexing-state.js`. `auto-indexer.ts:13-13`, `file-watcher.ts:23-23`, `git-watcher.ts:18-18`
- **./knowledge-bus.js** — Imports `./knowledge-bus.js` from `./knowledge-bus.js`. `auto-indexer.ts:14-14`, `resource-manager.ts:15-15`, `service-container.ts:28-28`
...
- **node:fs/promises** — Imports `node:fs/promises` from `node:fs/promises`. `file-watcher.ts:18-18`, `merkle-file-tracker.ts:15-15`
...
- **agentId** — Agent identifier for multi-agent coordination `client-session.ts:43-43`, `client-session.ts:72-72`
...
- **aiMessage** — Stores an AI-generated message or response `auto-indexer.ts:289-289`
...
- **avgMsPerEmb** — Average time per embedding in milliseconds `auto-indexer.ts:40-40`
- **batches** — Number of batches processed for embedding `auto-indexer.ts:39-39`
...
- **branch** — Represents the current branch of the project, optionally `client-session.ts:40-40`
...
- **cacheHits** — Number of cache hits during embedding processing `auto-indexer.ts:42-42`
...
- **clientId** — Client identifier from transport `client-session.ts:37-37`, `client-session.ts:68-68`
...
- **config** — Configuration for the branch manager, including max branches per repo and total branches `branch-manager.ts:66-70`, `branch-manager.ts:86-86`
...
- **cpuPercent** — CPU allocation percentage `resource-manager.ts:50-50`
- **cpuPercent** — Represents CPU usage percentage `resource-manager.ts:252-252`, `resource-manager.ts:264-264`
...
- **data** — Contains additional data about the task processing, including entity count and extracted entities `auto-indexer.ts:23-26`
...
- **detectedExt** — Stores the detected file extension `auto-indexer.ts:106-106`
...
- **directory** — Directory associated with an indexing operation `indexing-state.ts:11-11`, `indexing-state.ts:101-101`
...
- **duration** — The duration of the auto-indexing process `auto-indexer.ts:279-279`
- **durationMs** — Duration in milliseconds for embedding processing `auto-indexer.ts:36-36`
- **durationSeconds** — Measures the time taken for embedding operations in seconds `auto-indexer.ts:284-284`
...
- **embeddingEnabled** — Boolean indicating whether embeddings are enabled `startup-checks.ts:15-15`, `startup-checks.ts:56-56`
- **embeddingPerformance** — Tracks the performance metrics of embedding operations `auto-indexer.ts:281-288`
- **embeddingProvider** — String specifying the embedding provider `startup-checks.ts:16-16`
- **embeddingsPerSecond** — Calculates the rate of embeddings processed per second `auto-indexer.ts:285-285`
- **embeddingStats** — Embedding statistics for the auto-indexing process `auto-indexer.ts:280-280`
...
- **entities** — Array of extracted entities `auto-indexer.ts:25-25`, `auto-indexer.ts:27-27`
- **entitiesExtracted** — Counts the number of entities extracted during task processing `auto-indexer.ts:21-21`
- **entityCount** — Represents the count of entities extracted `auto-indexer.ts:24-24`
- **entityCount** — The number of entities extracted during auto-indexing `auto-indexer.ts:278-278`
...
- **evictionStrategy** — Strategy for evicting branches when the limit is exceeded `branch-manager.ts:69-69`, `branch-manager.ts:78-78`
- **exclude** — An array of glob patterns to exclude from the file watch `file-watcher.ts:40-40`
- **extraExcludePatterns** — Additional exclude patterns for source file counting and indexing `auto-indexer.ts:269-269`
- **factory** — Factory function to create instances `di-container.ts:41-41`
- **fastStartup** — Represents a boolean flag indicating whether the startup process is fast `merkle-file-tracker.ts:35-35`
...
- **filesProcessed** — Counts the number of files processed during task processing `auto-indexer.ts:22-22`
...
- **fullScan** — Indicates whether the auto-indexing is a full scan `auto-indexer.ts:270-270`
- **generated** — Indicates whether the auto-indexing was generated `auto-indexer.ts:280-280`
...
- **getConductor** — Retrieves a conductor agent for tasks `auto-indexer.ts:300-300`
- **getConductor** — Returns an instance of ConductorOrchestrator `service-container.ts:37-37`
- **getDevAgent** — Retrieves a development agent for tasks `auto-indexer.ts:298-298`
- **getDoraAgent** — Retrieves a Dora agent for tasks `auto-indexer.ts:299-299`
- **getEmbeddingStats** — Method to retrieve embedding statistics for an agent `auto-indexer.ts:34-43`
- **getGlobalVectorStore** — Returns an unknown value representing the global vector store `service-container.ts:39-39`
- **getGraphStorage** — Retrieves graph storage for tasks `auto-indexer.ts:301-301`
- **getIndexerAgent** — Retrieves an indexer agent for tasks `auto-indexer.ts:523-523`
- **getSemanticAgent** — Retrieves a semantic agent for processing tasks `auto-indexer.ts:297-297`
...
- **getTeiBatchLog** — Returns an array of objects containing the number of entities and the time in milliseconds for each batch `auto-indexer.ts:44-44`
...
- **id** — Unique identifier for a knowledge entry `knowledge-bus.ts:14-14`, `knowledge-bus.ts:23-23`
...
- **incremental** — Indicates whether the auto-indexing is incremental `auto-indexer.ts:267-267`
...
- **lastAccessed** — Stores the timestamp of the last access `branch-manager.ts:47-47`, `branch-manager.ts:54-54`
...
- **maxBatchMs** — Maximum time taken for a batch of embeddings in milliseconds `auto-indexer.ts:41-41`
- **maxBranchesPerRepo** — Maximum number of branches per repository `branch-manager.ts:67-67`, `branch-manager.ts:76-76`
- **maxConcurrency** — Sets the maximum concurrency for service resolution `di-container.ts:422-422`
- **maxTokens** — Sets the maximum token limit for input processing `auto-indexer.ts:289-289`
- **maxTotalBranches** — Maximum total number of branches across all repositories `branch-manager.ts:68-68`, `branch-manager.ts:77-77`
...
- **memoryMB** — Memory allocation in megabytes `resource-manager.ts:49-49`
- **memoryMB** — Represents memory usage in megabytes `resource-manager.ts:252-252`, `resource-manager.ts:264-264`
...
- **ms** — Represents the time in milliseconds for a batch `auto-indexer.ts:44-44`
- **msgQueue** — Queue for storing messages `knowledge-bus.ts:39-39`
- **n** — Represents the number of entities in a batch `auto-indexer.ts:44-44`
...
- **onclose** — Callback for close events `pipe-transport.ts:62-62`, `pipe-transport.ts:98-98`
- **onerror** — Callback for error events `pipe-transport.ts:61-61`, `pipe-transport.ts:97-97`
- **onmessage** — Callback for message events `pipe-transport.ts:60-60`, `pipe-transport.ts:96-96`
- **oversizedCount** — Counts the number of oversized inputs `auto-indexer.ts:289-289`
- **oversizedWarning** — Issues a warning if the size of the input exceeds a certain threshold `auto-indexer.ts:289-289`
...
- **pipeServerMode** — Boolean indicating whether the server is in pipe server mode `startup-checks.ts:17-17`, `startup-checks.ts:57-57`
...
- **processStartTime** — Records the start time of the indexing process `auto-indexer.ts:303-303`
- **processStartTime** — Number representing the start time of the process `startup-checks.ts:18-18`, `startup-checks.ts:58-58`
- **projectHash** — Stores the hash of the project `file-merkle.ts:28-28`
- **projectPath** — Represents the current project path `client-session.ts:31-31`
...
- **reset** — Resets the auto-indexing state `auto-indexer.ts:268-268`
...
- **sampleFile** — A sample file used for project detection `auto-indexer.ts:106-106`
...
- **sessionId** — Unique session ID for logging and debugging `client-session.ts:34-34`, `client-session.ts:67-67`
- **setCurrentIndexingDirectory** — Sets the current directory for indexing operations `auto-indexer.ts:302-302`
- **setRepositoryPath** — A method to set the repository path for an agent `auto-indexer.ts:51-51`
...
- **skipped** — Indicates whether the auto-indexing was skipped `auto-indexer.ts:280-280`
...
- **speedPerSec** — Speed of embedding processing in embeddings per second `auto-indexer.ts:37-37`
- **started** — Indicates whether the transport has been started `pipe-transport.ts:94-94`
- **startTime** — Start time of an indexing operation `indexing-state.ts:10-10`, `indexing-state.ts:21-21`
...
- **stop** — Represents a method to stop the file watcher `file-watcher.ts:69-69`
...
- **success** — Indicates whether the task processing was successful `auto-indexer.ts:20-20`
- **success** — Indicates whether the auto-indexing was successful `auto-indexer.ts:277-277`
- **supported** — Indicates whether a project is supported `auto-indexer.ts:106-106`
...
- **topic** — Topic to which the knowledge entry is associated `knowledge-bus.ts:15-15`, `knowledge-bus.ts:25-25`
...
- **total** — Total number of embeddings processed `auto-indexer.ts:35-35`
- **total** — Total memory in bytes `resource-manager.ts:31-31`
- **totalEmbeddings** — Counts the total number of embeddings processed `auto-indexer.ts:283-283`
...
- **workers** — Number of workers used for embedding processing `auto-indexer.ts:38-38`
- **workersUsed** — Indicates the number of workers used for embedding tasks `auto-indexer.ts:286-286`
...
- **DELETE FROM file_merkle WHERE project_hash = ? AND branch_name = ? AND path = ?** — Executes a SQL DELETE statement to remove a specific file_merkle record based on project_hash, branch_name, and path `file-merkle.ts:386-387`, `file-merkle.ts:399-400`
