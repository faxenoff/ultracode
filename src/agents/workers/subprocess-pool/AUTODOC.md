...
- **proc** — Process object `spawner.ts:78-78`, `spawner.ts:79-79`, `spawner.ts:80-84`
...
- **id** — number representing the ID of the subprocess worker `types.ts:41-41`
- **id** — Unique identifier for the request `types.ts:71-71`, `types.ts:83-83`
- **id** — Unique identifier for an embedding `types.ts:125-125`, `types.ts:142-142`
- **id** — Unique identifier for a task `types.ts:205-205`
...
- **metadata** — Metadata associated with the embedding `types.ts:128-128`, `types.ts:146-146`
...
- **type** — Type of the request, set to "parse" `types.ts:70-70`, `types.ts:82-82`
