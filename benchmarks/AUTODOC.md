...
- **baseline** — Represents the baseline performance of the cosine similarity computation `benchmark-simd.js:144-144`, `benchmark-simd.js:221-221`
...
- **largestEntity** — Identifies the largest code entity `embedding-benchmark.ts:669-669`, `embedding-benchmark.ts:818-818`
...
- **provider** — Represents a provider for benchmarking `embedding-benchmark.ts:269-269`, `embedding-benchmark.ts:269-269`, `embedding-benchmark.ts:269-269`, `embedding-benchmark.ts:269-269`
- **providerFilter** — Filters models based on provider `embedding-benchmark.ts:809-809`
- **responses** — Responses from the benchmarking process `embedding-benchmark.ts:363-368`, `embedding-benchmark.ts:368-368`
...
- **successful** — Indicates the status of the benchmark as successful `embedding-benchmark.ts:663-663`, `embedding-benchmark.ts:663-663`
- **successful** — Indicates if the benchmark was successful `embedding-benchmark.ts:1084-1084`, `embedding-benchmark.ts:1084-1084`
- **texts** — Maps chunks to their content `embedding-benchmark.ts:280-280`
- **totalTokens** — Total number of tokens in texts `embedding-benchmark.ts:288-288`
- **totalTokens** — Tracks the total number of tokens processed in the benchmark `embedding-benchmark.ts:384-384`, `embedding-benchmark.ts:464-464`, `embedding-benchmark.ts:572-572`
...
- **endpoint** — Specifies the endpoint URL for the benchmarking provider `embedding-benchmark.ts:539-539`, `embedding-benchmark.ts:614-614`
...
- **id** — Unique identifier for the benchmark result `embedding-benchmark.ts:29-29`, `embedding-benchmark.ts:51-51`
- **id** — Unique identifier for a code entity `embedding-benchmark.ts:192-192`
...
- **provider** — Stores the name of the embedding provider `embedding-benchmark.ts:30-30`
